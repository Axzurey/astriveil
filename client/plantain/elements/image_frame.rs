...
use crate::plantain::{elements::{element::{InputElement, UiElement}, screen::UiLayer}, render_queue::PipelineRefs, vertices::{image_vertex::ImageVertex, ui_vertex::UiVertex}};
...
impl UiElement for ImageFrame {
    ...
    fn draw(&mut self, device: &wgpu::Device, queue: &wgpu::Queue, render_pass: &mut RenderPass, pipeline_refs: &mut PipelineRefs, is_focused: bool) {
        ...
        render_pass.set_pipeline(pipeline_refs.image_pipeline);
